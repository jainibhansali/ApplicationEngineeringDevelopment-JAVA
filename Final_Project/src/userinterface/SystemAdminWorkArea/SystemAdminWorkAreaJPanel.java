...
//                customerList=enterprise.getCustomerDirectory().getCustomerList();
//                for(int c=0; c<customerList.size();c++)
//                {
//                customer = customerList.get(c);
//                customerNode = new DefaultMutableTreeNode(customer.getFullName());
//                enterpriseNode.insert(customerNode, c); 
//                }
    ...
    private void btnaddCustomerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnaddCustomerActionPerformed
        // TODO add your handling code here:
        AddCustomerJPanel addCustomerJPanel = new AddCustomerJPanel(userProcessContainer, system);
